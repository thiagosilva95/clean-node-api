...
import { mockHasher, mockAddAccountRepository, mockLoadAccountByEmailRepository } from '@/data/test/index'
...
describe('DbAddAccount Usecase', () => {
  test('Should call Encrypter with co_rrect password', async () => {
